...
<head>
    ...
    <title>Dashboard Edit Siswa</title>
    <?php
        ...
        <div class="panel-body container-fluid">
            <div class="panel-heading">
                ...
                <div class="breadcrumb d-flex justify-content-end align-items-end flex-wrap">
                    ...
                    <li class="breadcrumb breadcrumb-item">
                        <a href="?aksi=edit-siswa&id=<?= $_GET['id'] ?>" aria-current="page"
                            ...
                            <div class="card col-sm-8 col-md-8">
                                ...
                                <div class="card-body">
                                    <?php if (isset($_GET['id'])): ?>
                                        <?php $SQL = "SELECT * FROM siswa WHERE id_siswa = '$_GET[id]'"; ?>
                                        <?php $data = $konfigs->query($SQL); ?>
                                        <?php foreach ($data as $isi): ?>
                                            <?php extract($isi) ?>
                                            <form action="?aksi=siswa-edit" method="post">
                                                ...
                                                align-items-center flex-wrap">
                                                    ...
                                                    <div class="col-sm-6 col-md-6">
                                                        <input type="text" name="nama_siswa" value="<?= $nama_siswa ?>"
                                                            aria-required="TRUE" class="form-control" maxlength="100"
                                                            id="namasiswa">
                                                    </div>
                                                </div>
                                                <div class="my-2"></div>
                                                ...
                                                align-items-center flex-wrap">
                                                    ...
                                                    <div class="col-sm-6 col-md-6 ">
                                                        <select name="jenis_kelamin" class="form-select form-control" id=""
                                                            ...
                                                            <option <?php if ($isi['jenis_kelamin'] == "pria") { ?> selected
                                                                <?php } ?> value="Pria">Pria</option>
                                                            <option <?php if ($isi['jenis_kelamin'] == "wanita") { ?>
                                                                selected <?php } ?> value="Wanita">Wanita</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="my-2"></div>
                                                ...
                                                align-items-center flex-wrap">
                                                    ...
                                                    <div class="col-sm-6 col-md-6">
                                                        <input type="text" name="no_telepon" value="<?= $no_telepon ?>"
                                                            aria-required="TRUE" class="form-control" maxlength="25"
                                                            id="telepon">
                                                    </div>
                                                </div>
                                                <div class="my-2"></div>
                                                ...
                                                <div class="card-footer text-center">
                                                    ...
                                                    <a href="?page=siswa" type="button" class="btn btn-danger">
